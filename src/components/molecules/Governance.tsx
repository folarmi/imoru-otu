  ...
  return (
    ...
    <div className="my-20">
      ...
      <div className="mt-16">
        ...
        <div className="mt-8 w-full sm:w-[80%] lg:w-[64%] mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
          {executiveLeadership.map(({ id, name, type }) => {
            return (
              <div
                key={id}
                className="rounded-md border border-secondary p-6 text-center md:text-left"
              >
                <p className="text-secondary playfair font-semibold text-lg md:text-xl pb-2">
                  {name}
                </p>
                <p className="text-sm text-green_200">{type}</p>
              </div>
