...
const Membership = () => {
  return (
    ...
    <div className="bg-yellow_200 py-20">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center mx-6 sm:mx-10 lg:mx-20 gap-y-8 lg:gap-x-12 mt-12">
        {/* Who Can Join */}
        <section className="bg-primary border-2 border-secondary rounded-lg p-6 w-full lg:w-1/2 drop-shadow-card h-auto lg:h-[397px] flex flex-col">
          <p className="font-bold text-lg sm:text-xl md:text-2xl text-secondary playfair pb-4">
            Who Can Join?
          </p>
        ...
        {/* Member Benefits */}
        <section className="bg-primary border-2 border-secondary rounded-lg py-2 px-6 w-full lg:w-1/2 drop-shadow-card h-auto lg:h-[397px]">
          <p className="font-bold text-lg sm:text-xl md:text-2xl text-secondary playfair pb-4">
            Member Benefits
          </p>
