    ...
    <div className="mt-12 sm:mt-16 md:mt-24 px-4 sm:px-0">
      ...
      <section className="mt-8 sm:mt-12 md:mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
        <ProjectCard
          ...
          desc="Supporting students by distributing exercise books and educational materials to enhance learning in Imoru"
        />
        <ProjectCard
          img={communityEmpowerment}
          title="Community Empowerment"
          desc="Providing essential food supplies like rice and groundnut oil to support families and strengthen community well-being."
        />
        <ProjectCard
          img={projectOne}
          title="Community Health Support"
          desc="Offering blood pressure checks and essential health screenings to promote healthier lives."
        />
        <ProjectCard
          img={welfareInitiatives}
          title="Welfare Initiatives"
          desc="Community members receiving donated rice and essential supplies during a local outreach event supporting families in need."
        />
      </section>
